  ...
  return (
    <div>
      ...
      <main>
        ...
        >
          <h1
            className="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-gray-800 sm:text-7xl"
          >
            Elevate Your Business
            <span className="relative whitespace-nowrap text-red-600"> with Our</span>
            <span className="relative whitespace-nowrap text-red-500">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-2/3 left-0 h-[0.58em] w-full fill-red-500"
          ...
          <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-gray-400 text-gray-500 leading-7">
            Unlock the potential of your business with our comprehensive range of services. From capacity building and ICT training to policy research and international education, we provide tailored solutions designed to propel your success. Partner with Integral Development Konsult (IDK) and take your business to new heights.
          </h2>
        </div>
