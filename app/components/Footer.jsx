    ...
    <div>
      ...
      <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-gray-800">
        ...
        <div className="text-center">
          ...
          <div className="mt-3">
            <p className="text-gray-500">Developed By <a className="font-semibold text-blue-600 hover:text-blue-700" href="#">Hi Impact Choice Devops</a> team</p>
            <p className="text-gray-500">© IDK. 2024. All rights reserved.</p>
          </div>


          <div className="mt-3 space-x-2">
            <a className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" href="#">
