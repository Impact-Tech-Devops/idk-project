...
const About = () => {
 ...
 <div className="sm:flex items-center max-w-screen-xl">
        ...
        <div className="sm:w-1/2 p-5">
          <div className="text">
            <span className="text-gray-500 border-b-2 border-red-600 uppercase font-medium">
              About us
            </span>
            ...
            <p className="text-gray-700">
              Integral Development Konsult (IDK) is a multi-disciplinary
              learning capacity building, placements and performanceconsulting
              firm with core competencies in management development, building
              placements, entrepreneurship and business development, ICT
              Training and Computer-based testing, schools and teacher
              development, creative educational competitions and fairs,
              international education and global learning services and policy
              research.
            </p>
          </div>
        </div>
      </div>
      <section className="overflow-hidden bg-slate-100 py-8 sm:py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="text-base font-semibold leading-7 text-red-600">Intergral Development konsult</h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">More about us</p>
                <p className="mt-6 text-lg font-medium leading-8 text-gray-700">Get a glimpse into what drives us and our modus operandi
                </p>
                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                  <div className="relative pl-9">
                    ...
                    </svg>VISION STATEMENT
                    </dt>
                    <dd className="inline"> Our vision isto be the foremostreliable and committed learning and business solutions provider in Nigeria with strong partnering
                      networks globally.
                  ...
                  <div className="relative pl-9">
                    ...
                    <dd className="inline">
                      <span className="text-red-500"> Our mission </span> is to empower clients for career and organizational success through innovative learning programs and business services, delivered with integrity and excellence</dd>
                  </div>
              ...
              <div className="mt-10 flex items-center gap-x-6">
                <Link href="/contact"
                  className="rounded-full bg-red-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Contact Us
                </Link>
      ...
      <div className="max-w-4xl mx-auto px-5 mt-16 mb-10">
        <div className="text-center">
          <h2 className="font-semibold text-3xl">OUR CORE VALUES AND STRENGTH</h2>
          <p className="max-w-md mx-auto mt-2 text-gray-500">The core values which govern the way we work include:</p>
        </div>

        <div className="grid md:grid-cols-2 gap-10 mt-10">
          <div className="flex gap-4 items-start">
            <span className="text-red-600 bg-red-500/10 p-3 rounded-full">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-500">  We are reliable with high sense of integrity. We have strong business and moral principles. We keep our word!</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl">Discipline</h3>
              <p className="mt-1 text-gray-500">  We work strictly according to established guidelines. We respect the agreement.</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-500"> We trust our methods to deliver desired performance results. We exceed our targets.</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-500"> We put our clients at the center of what we do. </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl">Problem-solving</h3>
              <p className="mt-1 text-gray-500"> We value, challenge, and reward our people. </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-500"> We continuously build culture of excellence.</p>
            </div>
          </div>
