            ...
            <div class="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
              ...
              >
                ...
                >
                  <span class="flex">
                    <svg
                      class="flex-shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-red-600 text-gray-800 dark:hs-tab-active:text-red-500 dark:text-gray-200"
                    ...
                    <span class="grow ms-6">
                      <span class="block text-lg font-semibold hs-tab-active:text-red-600 text-gray-800 dark:hs-tab-active:text-red-500 dark:text-gray-200">
                        Advanced tools
                      </span>
